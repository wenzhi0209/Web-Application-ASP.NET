<%@ Page Language="C#" MasterPageFile="~/Master_Page/author_Loged.Master" AutoEventWireup="true" CodeBehind="AuthorResetPassword.aspx.cs" Inherits="Assignment_Template.ChangePasswordaspx" %>
                ...
                <table class="loginBox">
                    ...
                    <tr>
                        <td class="auto-style4">
                            <asp:Button ID="Button1" runat="server" PostBackUrl="~/artistProfileInfo.aspx" Text="Update" OnClick="Button1_Click" />
                        </td>
                        <td class="auto-style1">&nbsp;</td>
                    </tr>
                </table>
