        ...
        <table>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [art_Title], [art_Img], [art_Detail], [art_Price], [available_Qty], [art_Id] FROM [Art]" DeleteCommand="DELETE FROM [Art] WHERE [art_Id] = @art_Id" InsertCommand="INSERT INTO [Art] ([art_Title], [art_Img], [art_Detail], [art_Price], [available_Qty]) VALUES (@art_Title, @art_Img, @art_Detail, @art_Price, @available_Qty)" UpdateCommand="UPDATE [Art] SET [art_Title] = @art_Title, [art_Img] = @art_Img, [art_Detail] = @art_Detail, [art_Price] = @art_Price, [available_Qty] = @available_Qty WHERE [art_Id] = @art_Id">
                        <DeleteParameters>
