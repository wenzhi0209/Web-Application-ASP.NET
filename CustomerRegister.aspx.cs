...
namespace Assignment_Template
{
    public partial class CustomerRegister : System.Web.UI.Page
    {
        ...
        protected void CreateUserWizard1_CreatedUser(object sender, EventArgs e)
        {
            ...
            string insertNewCustomer = "INSERT INTO Customer (cust_Name, cust_PhoneNo, cust_Address, cust_Gender, UserId, Dob) VALUES(@name,@PhoneNo,@Address,@Gender,@userId, @Dob)";
